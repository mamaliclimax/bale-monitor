...
def extract_forward(message):
    ...
    if forward_from_chat:
        ...
        forward_username = (
            forward_from_chat.get("username")
        )
...
def report():
    ...
    if not source:
        ...
        return (
            "❌ هنوز کانال مرجع تعیین نشده است."
        )
    ...
    # -----------------------------------------------------
    # فقط گزارش‌های مربوط به منبع فعلی
    # -----------------------------------------------------
    ...
    if not filtered:
        ...
        return (
            ...
            "از این کانال در کانال‌های "
            "تحت نظر شناسایی نشده است."
        )
