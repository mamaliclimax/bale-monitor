...
def now_iso():
    """
    زمان ذخیره‌سازی در دیتابیس به UTC
    """
...
def load_selected_source():
    ...
    # لینک صحیح را همیشه دوباره می‌سازیم
    correct_link = (
...
def command_add_admin(
    ...
    if target.startswith("@"):
        ...
        target_user_id = user.get(
            "user_id"
        )

        target_username = user.get(
            "username"
        )
    ...
    try:
        ...
        if result.data:
            ...
            for index, admin in enumerate(
                ...
                lines.append(
                    f"{to_persian_digits(index)}. {name}\n"
                    f"   ID: {user_id}"
                )
    ...
    try:
        ...
        for index, channel in enumerate(
            ...
            lines.append(
                ...
                f"{to_persian_digits(index)}. {title}\n"
...
def command_status(
    ...
    text = (
        ...
        f"{to_persian_digits(channel_count)}\n\n"
...
def start_message(
    ...
    if not is_admin(
        ...
        send_message(
            ...
            "شما دسترسی مدیریتی به این ربات را ندارید.\n\n"
